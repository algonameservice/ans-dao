...
def approval_program(ARG_GOV_TOKEN):
    ...
    vote = Seq([
        ...
        is_delegated := App.localGetEx(Txn.sender(), Int(2), Bytes("delegated_to")),
        delegated_amount := App.localGetEx(Txn.sender(), Int(2), Bytes("delegated_amount")),
        If(
            And(
                is_delegated.hasValue(),
